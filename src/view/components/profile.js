      ...
      + '<section class="profilemetacontent"">'
        ...
        + '<section class="profilemetaright">'
          ...
          + '<section class="profilecounts">'
            + '<section class="statuscount"><span v-text="user.statusesCount"></span>&nbsp;<span class="profilecounttag">tweets</span></section>'
            + '<section class="friendcount"><span v-text="user.friendsCount"></span>&nbsp;<span class="profilecounttag">following</span></section>'
            + '<section class="followercount"><span v-text="user.followersCount"></span>&nbsp;<span class="profilecounttag">followers</span></section>'
          + '</section>'
        + '</section>'
      + '</section>'
    + '</section>'
