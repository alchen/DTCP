...
var PUB_STREAM    = 'https://stream.twitter.com/1.1/';
var USER_STREAM   = 'https://userstream.twitter.com/1.1/';
var SITE_STREAM   = 'https://sitestream.twitter.com/1.1/';
var MEDIA_UPLOAD  = 'https://upload.twitter.com/1.1/';
var OA_REQ        = 'https://api.twitter.com/oauth/request_token';
var OA_ACCESS     = 'https://api.twitter.com/oauth/access_token';
...
Twitter.prototype = {
  ...
  request: function (method, path, params, callback) {
    ...
    if (path === 'media/upload') {
      // build the full url
      finalPath = MEDIA_UPLOAD + path + '.json';
  ...
  stream: function (path, params) {
    ...
    var ROOT = streamEndpointMap[path] || PUB_STREAM;
